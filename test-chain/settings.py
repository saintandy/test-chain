"""
Django settings for test-chain project.
...
AUTH_USER_MODEL = "test-chainapp.User"
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                "test-chainapp.context_processor.default",
            ],
        },
    },
]
...
WSGI_APPLICATION = 'test-chain.wsgi.application'
